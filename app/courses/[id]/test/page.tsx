      ...
      <div className="p-4 md:p-8 max-w-2xl md:max-w-4xl mx-auto space-y-6 md:space-y-8">
        <Card className="text-center md:p-8 p-6 overflow-hidden relative">
          ...
          <CardHeader>
            ...
            <CardTitle className="text-2xl md:text-3xl">{passed ? "Congratulations!" : "Test Not Passed"}</CardTitle>
            ...
            {passed ? (
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                  <Button className="gap-2 w-full md:w-auto" onClick={handleDownload}>
          ...
          <CardFooter className="justify-center border-t pt-4 md:pt-6">
            <Button variant="ghost" className="gap-2 text-sm md:text-base" asChild>
              <Link href="/">
    ...
    <div className="p-4 md:p-8 max-w-2xl md:max-w-3xl mx-auto space-y-6 md:space-y-8">
      ...
      <Card>
        <CardHeader className="p-4 md:p-6">
          <CardTitle className="text-lg md:text-xl font-medium leading-relaxed">{currentQuestion.question}</CardTitle>
        </CardHeader>
